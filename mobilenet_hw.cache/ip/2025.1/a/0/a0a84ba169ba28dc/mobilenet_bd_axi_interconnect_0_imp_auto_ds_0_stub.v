...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ mobilenet_bd_axi_interconnect_0_imp_auto_ds_0_stub.v
...
(* CHECK_LICENSE_TYPE = "mobilenet_bd_axi_interconnect_0_imp_auto_ds_0,axi_dwidth_converter_v2_1_36_top,{}" *) (* CORE_GENERATION_INFO = "mobilenet_bd_axi_interconnect_0_imp_auto_ds_0,axi_dwidth_converter_v2_1_36_top,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_dwidth_converter,x_ipVersion=2.1,x_ipCoreRevision=36,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynq,C_AXI_PROTOCOL=0,C_S_AXI_ID_WIDTH=1,C_SUPPORTS_ID=0,C_AXI_ADDR_WIDTH=64,C_S_AXI_DATA_WIDTH=64,C_M_AXI_DATA_WIDTH=32,C_AXI_SUPPORTS_WRITE=1,C_AXI_SUPPORTS_READ=1,C_FIFO_MODE=0,C_S_AXI_ACLK_RATIO=1,C_M_AXI_ACLK_RATIO=2,C_AXI_IS_ACLK_ASYNC=0,C_MAX_SPLIT_BEATS=256,C_PACKING_LEVEL=1,C_SYNCHRONIZER_STAGE=3}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
